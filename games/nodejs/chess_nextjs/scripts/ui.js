...
CHESSAPP.ui = (function () {
  ...
  var createChat = function (chatID) {
	...
	chatInput.classList.add("hiddenContainer");
    chatWindow = document.createElement("div");
    chatWindow.className = "chatContainer";

    var cw = chatWindow,
      ci = chatInput,
      def = "Escriba su mensaje aquí...";
    ...
    header.appendChild(document.createTextNode("Turnos"));
  ...
  var createMovelist = function () {
    ...
    header.appendChild(document.createTextNode("Movimientos"));
  ...
  var createColor = function () {
    ...
    h2.appendChild(document.createTextNode("Elige tu color"));
    a.setAttribute("data-color", "W");
    a.appendChild(document.createTextNode("Blancas"));
    a2.setAttribute("data-color", "B");
    a2.appendChild(document.createTextNode("Negras"));
    a3.setAttribute("data-color", "U");
    a3.appendChild(document.createTextNode("Sin preferencia"));
    span.appendChild(document.createTextNode("Blancas/negras"));
    a3.appendChild(span);
  ...
  createInitial = function () {
    ...
    h2.appendChild(document.createTextNode("Elige tu modo de juego"));
    a.setAttribute("data-mode", "offline");
    a.appendChild(document.createTextNode("Modo Offline"));
    a2.setAttribute("data-mode", "online");
    a2.appendChild(document.createTextNode("Modo Online"));
  ...
  var createStatus = function (statusID) {
    ...
    statusWindow = new statusScroller({ elem: status, maxLines: 10 });
  ...
  function createSwapingUI() {

	const status = document.getElementsByClassName("status")[0];
	const chatContainer = document.getElementsByClassName("chatContainer")[0];

	chatContainer.parentNode.insertBefore( status, chatContainer);
	chatContainer.classList.add("hiddenContainer");
	// hiddenContainer.appendChild(chatContainer);
  ...
  that.statusUpdate = function (stg) {
	...
	if(stg.msg.startsWith("Jugando como")){
		const headerTurno = document.getElementById("chatHeader");
		headerTurno.innerHTML = "Turnos - eres las " + stg.msg.split(" ")[2];
	}
